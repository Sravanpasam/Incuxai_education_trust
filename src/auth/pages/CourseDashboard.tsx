  ...
  return (
    <div className="lms-root">
      ...
      {currentPage === 'course' && (
        ...
        {!COURSE_LIVE && (
          <div className="lms-course-lock-overlay" style={{ position: 'absolute', inset: 0, background: 'rgba(12, 22, 40, 0.55)', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem', zIndex: 50 }}>
            <div style={{ background: '#ffffff', borderRadius: '20px', boxShadow: '0 24px 60px rgba(12, 22, 40, 0.25)', maxWidth: '480px', width: '100%', overflow: 'hidden', fontFamily: 'Inter, sans-serif' }}>
              <div style={{ background: 'linear-gradient(135deg, #0c1628 0%, #1e3a5f 100%)', padding: '2rem 2.5rem 1.75rem' }}>
                ...
                <h2 style={{ margin: '0.9rem 0 0', color: '#ffffff', fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: '1.6rem', fontWeight: 800, letterSpacing: '-0.01em' }}>Course Coming Soon</h2>
